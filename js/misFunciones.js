function traerInformacionCategorias(){
    $.ajax({
        url:"http://155.248.211.178:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://155.248.211.178:8080/api/Category/save",
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://155.248.211.178:8080/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://155.248.211.178:8080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function traerInformacionFincas(){
    $.ajax({
        url:"http://155.248.211.178:8080/api/Farm/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionFincas(){
    let var2 = {
        ...
        url:"http://155.248.211.178:8080/api/Farm/save",
...
function actualizarInformacionFinca(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://155.248.211.178:8080/api/Farm/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarFinca(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://155.248.211.178:8080/api/Farm/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
